        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Transform raw data into actionable insights through statistical
                analysis, exploratory data analysis, and performance tracking.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Develop and deploy models, dashboards, and analytics workflows
                that support decision-making and automate reporting.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
